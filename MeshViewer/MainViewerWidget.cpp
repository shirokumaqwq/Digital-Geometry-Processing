...
void MainViewerWidget::CreateParamWidget(void)
{
	...
	connect(meshparamwidget, SIGNAL(sShortestPath()), meshviewerwidget, SLOT(ShortestPath()));
	connect(meshparamwidget, SIGNAL(sMinTree()), meshviewerwidget, SLOT(MinSpanTree()));
	connect(meshparamwidget, SIGNAL(sMeanCurvature()), meshviewerwidget, SLOT(DrawMeanCurvature()));
	connect(meshparamwidget, SIGNAL(sGaussianCurvature()), meshviewerwidget, SLOT(DrawGaussianCurvature()));
	connect(meshparamwidget, SIGNAL(sBilateralNormalFilter()), meshviewerwidget, SLOT(DoBilateralNormalFilter()));
	connect(meshparamwidget, SIGNAL(sAddNoise()), meshviewerwidget, SLOT(AddNoise()));
	connect(meshparamwidget, SIGNAL(sParameterization()), meshviewerwidget, SLOT(DoParameterization()));
	connect(meshparamwidget, SIGNAL(sARAP()), meshviewerwidget, SLOT(DoARAP()));
...
void MainViewerWidget::Open(void)
{
	QString fileName = QFileDialog::getOpenFileName(this,
		tr("Open mesh file"),
		tr("D:/QWQ/data/mesh/triangle mesh"),
